...
/home/ubuntu/rust/ultra-os/codes/riscv-syscalls-testing/user/build/riscv64/yield_B:     file format elf64-littleriscv
    ...
    1008:	6491                	lui	s1,0x4
{
    ...
    101c:	24248493          	addi	s1,s1,578 # 4242 <digits+0x2382>
        buf[WIDTH] = 0;
        printf("%s [%d/%d]\n", buf, i + 1, HEIGHT);
