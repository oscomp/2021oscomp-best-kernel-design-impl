...
/home/ubuntu/rust/ultra-os/codes/riscv-syscalls-testing/user/build/riscv64/dup:     file format elf64-littleriscv
...
void test_dup(){
    ...
    1048:	ee450513          	addi	a0,a0,-284 # 1f28 <__clone+0x8e>
    ...
    1070:	e8450513          	addi	a0,a0,-380 # 1ef0 <__clone+0x56>
    ...
    1328:	18bc                	addi	a5,sp,120
{
    ...
    1352:	beab0b13          	addi	s6,s6,-1046 # 1f38 <__clone+0x9e>
    buf[i++] = '0';
...
size_t strlen(const char *s)
{
    ...
    18a8:	69c5b583          	ld	a1,1692(a1) # 1f40 <__clone+0xa6>
    18ac:	00000617          	auipc	a2,0x0
    18b0:	69c63603          	ld	a2,1692(a2) # 1f48 <__clone+0xae>
    ...
    18e0:	00757713          	andi	a4,a0,7
{
    ...
    1910:	64453503          	ld	a0,1604(a0) # 1f50 <__clone+0xb6>
    ...
    1922:	6228b883          	ld	a7,1570(a7) # 1f40 <__clone+0xa6>
    1926:	00000817          	auipc	a6,0x0
    192a:	62283803          	ld	a6,1570(a6) # 1f48 <__clone+0xae>
    192e:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19b0:	59463603          	ld	a2,1428(a2) # 1f40 <__clone+0xa6>
    19b4:	00000817          	auipc	a6,0x0
    19b8:	59483803          	ld	a6,1428(a6) # 1f48 <__clone+0xae>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1b92:	3b28b883          	ld	a7,946(a7) # 1f40 <__clone+0xa6>
    1b96:	00000817          	auipc	a6,0x0
    1b9a:	3b283803          	ld	a6,946(a6) # 1f48 <__clone+0xae>
    1b9e:	431d                	li	t1,7
