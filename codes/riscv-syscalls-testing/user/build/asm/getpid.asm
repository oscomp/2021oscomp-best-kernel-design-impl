...
/home/ubuntu/rust/ultra-os/codes/riscv-syscalls-testing/user/build/riscv64/getpid:     file format elf64-littleriscv
...
int test_getpid()
{
    ...
    100a:	eba50513          	addi	a0,a0,-326 # 1ec0 <__clone+0x28>
{
    ...
    1024:	eb850513          	addi	a0,a0,-328 # 1ed8 <__clone+0x40>
    ...
    103a:	ed250513          	addi	a0,a0,-302 # 1f08 <__clone+0x70>
    103e:	2e0000ef          	jal	ra,131e <printf>
    TEST_END(__func__);
    1042:	00001517          	auipc	a0,0x1
    1046:	ee650513          	addi	a0,a0,-282 # 1f28 <__clone+0x90>
    104a:	2b2000ef          	jal	ra,12fc <puts>
    104e:	00001517          	auipc	a0,0x1
    1052:	f0a50513          	addi	a0,a0,-246 # 1f58 <__func__.0>
    1056:	2a6000ef          	jal	ra,12fc <puts>
}
    105a:	60e2                	ld	ra,24(sp)
    TEST_END(__func__);
    105c:	00001517          	auipc	a0,0x1
    1060:	e7c50513          	addi	a0,a0,-388 # 1ed8 <__clone+0x40>
}
    ...
    106e:	e7e50513          	addi	a0,a0,-386 # 1ee8 <__clone+0x50>
    ...
    10a6:	f406                	sd	ra,40(sp)
{
    ...
    10b4:	eb860613          	addi	a2,a2,-328 # 1f68 <digits>
    buf[16] = 0;
    ...
    11ea:	d8260613          	addi	a2,a2,-638 # 1f68 <digits>
    buf[16] = 0;
    ...
    1326:	18bc                	addi	a5,sp,120
{
    ...
    1350:	becb0b13          	addi	s6,s6,-1044 # 1f38 <__clone+0xa0>
    buf[i++] = '0';
    1354:	830aca93          	xori	s5,s5,-2000
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1358:	00001997          	auipc	s3,0x1
    135c:	c1098993          	addi	s3,s3,-1008 # 1f68 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    18a6:	69e5b583          	ld	a1,1694(a1) # 1f40 <__clone+0xa8>
    18aa:	00000617          	auipc	a2,0x0
    18ae:	69e63603          	ld	a2,1694(a2) # 1f48 <__clone+0xb0>
    ...
    18de:	00757713          	andi	a4,a0,7
{
    ...
    190e:	64653503          	ld	a0,1606(a0) # 1f50 <__clone+0xb8>
    ...
    1920:	6248b883          	ld	a7,1572(a7) # 1f40 <__clone+0xa8>
    1924:	00000817          	auipc	a6,0x0
    1928:	62483803          	ld	a6,1572(a6) # 1f48 <__clone+0xb0>
    192c:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19ae:	59663603          	ld	a2,1430(a2) # 1f40 <__clone+0xa8>
    19b2:	00000817          	auipc	a6,0x0
    19b6:	59683803          	ld	a6,1430(a6) # 1f48 <__clone+0xb0>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1b90:	3b48b883          	ld	a7,948(a7) # 1f40 <__clone+0xa8>
    1b94:	00000817          	auipc	a6,0x0
    1b98:	3b483803          	ld	a6,948(a6) # 1f48 <__clone+0xb0>
    1b9c:	431d                	li	t1,7
...
0000000000001d88 <spawn>:
    register long a7 __asm__("a7") = n;
    1d88:	19000893          	li	a7,400
    __asm_syscall("r"(a7), "0"(a0))
    1d8c:	00000073          	ecall
...
0000000000001d94 <mailread>:
    register long a7 __asm__("a7") = n;
    1d94:	19100893          	li	a7,401
    __asm_syscall("r"(a7), "0"(a0), "r"(a1))
    1d98:	00000073          	ecall
...
0000000000001da0 <mailwrite>:
    register long a7 __asm__("a7") = n;
    1da0:	19200893          	li	a7,402
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1da4:	00000073          	ecall
...
0000000000001dac <fstat>:
    register long a7 __asm__("a7") = n;
    1dac:	05000893          	li	a7,80
    __asm_syscall("r"(a7), "0"(a0), "r"(a1))
    1db0:	00000073          	ecall
...
0000000000001db8 <sys_linkat>:
    register long a4 __asm__("a4") = e;
    1db8:	1702                	slli	a4,a4,0x20
    register long a7 __asm__("a7") = n;
    1dba:	02500893          	li	a7,37
    register long a4 __asm__("a4") = e;
    1dbe:	9301                	srli	a4,a4,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4))
    1dc0:	00000073          	ecall
...
0000000000001dc8 <sys_unlinkat>:
    register long a2 __asm__("a2") = c;
    1dc8:	1602                	slli	a2,a2,0x20
    register long a7 __asm__("a7") = n;
    1dca:	02300893          	li	a7,35
    register long a2 __asm__("a2") = c;
    1dce:	9201                	srli	a2,a2,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1dd0:	00000073          	ecall
