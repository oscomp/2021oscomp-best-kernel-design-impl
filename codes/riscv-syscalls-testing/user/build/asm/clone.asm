...
/home/ubuntu/rust/ultra-os/codes/riscv-syscalls-testing/user/build/riscv64/clone:     file format elf64-littleriscv
...
static int child_func(void){
    ...
    printf("  Child says successfully!\n");
    1010:	368000ef          	jal	ra,1378 <printf>
    return 0;
}
...
void test_clone(void){
    ...
    1022:	f2250513          	addi	a0,a0,-222 # 1f40 <__clone+0x4e>
void test_clone(void){
    1026:	ec06                	sd	ra,24(sp)
    1028:	e822                	sd	s0,16(sp)
    TEST_START(__func__);
    102a:	32c000ef          	jal	ra,1356 <puts>
    102e:	00003517          	auipc	a0,0x3
    1032:	fca50513          	addi	a0,a0,-54 # 3ff8 <__func__.0>
    1036:	320000ef          	jal	ra,1356 <puts>
    103a:	00001517          	auipc	a0,0x1
    103e:	f1e50513          	addi	a0,a0,-226 # 1f58 <__clone+0x66>
    1042:	314000ef          	jal	ra,1356 <puts>
    int wstatus;
    child_pid = clone(child_func, NULL, stack, 1024, SIGCHLD);
    1046:	4745                	li	a4,17
    1048:	40000693          	li	a3,1024
    104c:	00001617          	auipc	a2,0x1
    1050:	fa460613          	addi	a2,a2,-92 # 1ff0 <stack>
    1054:	4581                	li	a1,0
    1056:	00000517          	auipc	a0,0x0
    105a:	fae50513          	addi	a0,a0,-82 # 1004 <child_func>
    105e:	49f000ef          	jal	ra,1cfc <clone>
    1062:	00003417          	auipc	s0,0x3
    1066:	f8e40413          	addi	s0,s0,-114 # 3ff0 <child_pid>
    106a:	c008                	sw	a0,0(s0)
    assert(child_pid != -1);
    106c:	57fd                	li	a5,-1
    106e:	04f50b63          	beq	a0,a5,10c4 <test_clone+0xa8>
    if (child_pid == 0){
    1072:	ed15                	bnez	a0,10ae <test_clone+0x92>
	    printf("child pid = %d", child_pid);
    1074:	4581                	li	a1,0
    1076:	00001517          	auipc	a0,0x1
    107a:	f1250513          	addi	a0,a0,-238 # 1f88 <__clone+0x96>
    107e:	2fa000ef          	jal	ra,1378 <printf>
    }else{
	    wait(&wstatus);
    ...
    1086:	f3e50513          	addi	a0,a0,-194 # 1fc0 <__clone+0xce>
    108a:	2cc000ef          	jal	ra,1356 <puts>
    108e:	00003517          	auipc	a0,0x3
    1092:	f6a50513          	addi	a0,a0,-150 # 3ff8 <__func__.0>
    1096:	2c0000ef          	jal	ra,1356 <puts>
    109a:	00001517          	auipc	a0,0x1
    109e:	ebe50513          	addi	a0,a0,-322 # 1f58 <__clone+0x66>
    10a2:	2b4000ef          	jal	ra,1356 <puts>
}
    ...
    10b0:	521000ef          	jal	ra,1dd0 <wait>
	    printf("clone process successfully.\npid:%d\n", child_pid);
    10b4:	400c                	lw	a1,0(s0)
    10b6:	00001517          	auipc	a0,0x1
    10ba:	ee250513          	addi	a0,a0,-286 # 1f98 <__clone+0xa6>
    10be:	2ba000ef          	jal	ra,1378 <printf>
    10c2:	b7c1                	j	1082 <test_clone+0x66>
    assert(child_pid != -1);
    10c4:	00001517          	auipc	a0,0x1
    10c8:	ea450513          	addi	a0,a0,-348 # 1f68 <__clone+0x76>
    10cc:	530000ef          	jal	ra,15fc <panic>
    if (child_pid == 0){
    10d0:	4008                	lw	a0,0(s0)
    10d2:	b745                	j	1072 <test_clone+0x56>
...
int main(void){
    ...
    test_clone();
    10d8:	f45ff0ef          	jal	ra,101c <test_clone>
    return 0;
}
    ...
    1100:	f406                	sd	ra,40(sp)
{
    ...
    110a:	00003617          	auipc	a2,0x3
    110e:	efe60613          	addi	a2,a2,-258 # 4008 <digits>
    buf[16] = 0;
    ...
    1240:	00003617          	auipc	a2,0x3
    1244:	dc860613          	addi	a2,a2,-568 # 4008 <digits>
    buf[16] = 0;
    ...
    1380:	18bc                	addi	a5,sp,120
{
    ...
    13aa:	c2ab0b13          	addi	s6,s6,-982 # 1fd0 <__clone+0xde>
    buf[i++] = '0';
    13ae:	830aca93          	xori	s5,s5,-2000
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    13b2:	00003997          	auipc	s3,0x3
    13b6:	c5698993          	addi	s3,s3,-938 # 4008 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    1900:	6dc5b583          	ld	a1,1756(a1) # 1fd8 <__clone+0xe6>
    1904:	00000617          	auipc	a2,0x0
    1908:	6dc63603          	ld	a2,1756(a2) # 1fe0 <__clone+0xee>
    ...
    1938:	00757713          	andi	a4,a0,7
{
    ...
    1968:	68453503          	ld	a0,1668(a0) # 1fe8 <__clone+0xf6>
    ...
    197a:	6628b883          	ld	a7,1634(a7) # 1fd8 <__clone+0xe6>
    197e:	00000817          	auipc	a6,0x0
    1982:	66283803          	ld	a6,1634(a6) # 1fe0 <__clone+0xee>
    1986:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    1a08:	5d463603          	ld	a2,1492(a2) # 1fd8 <__clone+0xe6>
    1a0c:	00000817          	auipc	a6,0x0
    1a10:	5d483803          	ld	a6,1492(a6) # 1fe0 <__clone+0xee>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1bea:	3f28b883          	ld	a7,1010(a7) # 1fd8 <__clone+0xe6>
    1bee:	00000817          	auipc	a6,0x0
    1bf2:	3f283803          	ld	a6,1010(a6) # 1fe0 <__clone+0xee>
    1bf6:	431d                	li	t1,7
