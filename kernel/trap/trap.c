...
uchar const floatstore[] __attribute__((section(".rodata.floatstore"))) = {
// uchar const floatstore [] = {
...
uchar const floatload[] __attribute__((section(".rodata.floatload"))) = {
// uchar const floatload[] = {
