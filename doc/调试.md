...
<img src="pic/image-20210813111924281.png" alt="image-20210813111924281" style="zoom:50%;" />

再次qemu，又不行了

<img src="pic/image-20210813113136957.png" alt="image-20210813113136957" style="zoom:50%;" />
...
<img src="pic/image-20210813222025676.png" alt="image-20210813222025676" style="zoom: 45%;" />
...
newStat结构问题。。至此，我们应该逆向工程出了准确的结构：
...
内存还是不足了，将堆的大小调整为0x80个page（减小一半），可以通过
